          ...
          while ($m = mysqli_fetch_array($executeSat)) {
            ...
            <li>
              ...
              <?php if ($m['konfirm_selesai'] != 'Y'): ?>
                <a href="aksi/proses_selesai_order_kurir.php?id_order=<?= $m['id']; ?>&jenis_pembayaran=<?= $m['jenis_pembayaran']; ?>&id_member=<?= $m['id_member']; ?>&rupiah=<?= $m['rupiah']; ?>"
                  class="btn btn-sm gradient-light-success">
                  <i class="fa-solid fa-hand-pointer"></i> Ambil
                </a>
              <?php endif; ?>
