            ...
            <section id="centered-pills">
               <ul class="nav nav-pills nav-active-bordered-pill justify-content-center">
                  <li class="nav-item  m-1">
                     <a class="nav-link active btn btn-icon rounded-0" id="all-tab" data-toggle="pill"
                        href="#all-center" aria-expanded="true"><i class="fa-solid fa-clipboard-check"></i></a>
                  </li>
                  <?php
                  ...
                  while ($b = mysqli_fetch_array($executeSat)) {
                     ...
                     ?>
                     <li class="nav-item  m-1">
                        <a class="nav-link btn btn-icon rounded-0" id="<?php echo $b['kd_pembelian_status']; ?>-tab"
                           data-toggle="pill" href="#<?php echo $b['kd_pembelian_status']; ?>" aria-expanded="false"><i
                              class="<?php echo $b['icon']; ?>"></i></a>
                     </li>
               ...
               <div class="tab-content m-0 p-0">
                              ...
                              while ($b = mysqli_fetch_array($executeSat)) {
                                 ...
                                 <tr>
                                    <td class="font-small-3">
                                       <strong>
                                          <?= $b['no_faktur_pembelian'] ?>
                                       </strong><br>
                                       <p class="text-italic font-small-1"><i class="fa-regular fa-clock"></i>
                                          <?= $b['tgl_pembelian'] ?>
                                       </p>
                                    </td>
                                    <td class="font-small-1"><sup>Rp. </sup>
                                       <?= number_format($b['total_biaya'], 0, ",", "."); ?>
                                    </td>
                                    <td class="font-small-1">
                                       <?= $b['nm_pembelian_status']; ?>
                                    </td>
                                 </tr>
                              <?php } ?>
                           </tbody>
                  ...
                  while ($bc = mysqli_fetch_array($executeSatc)) {
                     ...
                     ?>
                     <div class="tab-pane" id="<?php echo $bc['kd_pembelian_status']; ?>" role="tabpanel"
                        aria-labelledby="<?php echo $bc['kd_pembelian_status']; ?>-tab" aria-expanded="false">

                        <div class="card-header">
                           <h4 class="card-title">
                              <?php echo $bc['nm_pembelian_status']; ?>
                           </h4>
                        </div>
                        <div class="table-responsive">
                           <table class="table nowrap scroll-horizontal-vertical">
