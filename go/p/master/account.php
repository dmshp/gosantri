<?php
$a = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM tabel_member")); ?>
<!-- BEGIN: Content-->
    ...
    <form>
     <div class="row">
       <div class="col-12 col-sm-6">
         ...
         <div class="form-group">
           <label>Name</label>
              <input type="text" class="form-control" value="Nama asli">
         </div>
         <div class="form-group">                         
           <label>E-mail</label>
             <input type="email" class="form-control" value="member@gmail.com">
         </div>
       </div>
       <div class="col-12 col-sm-6">
         <div class="form-group">
        ...
        <div class="text-center align-self-center p-2">
			<button type="submit" class="btn btn-primary glow mb-1 mb-sm-0"><i class="fa-solid fa-paper-plane mr-1"></i>Simpan</button>
		</div>
       </div>
      </form>
    </div>
