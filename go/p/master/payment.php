<?php
$payment = mysqli_fetch_array(mysqli_query($koneksi, "SELECT tm.bank, tm.an_rekening, tm.no_rekening, ts.jumlah FROM tabel_member AS tm JOIN tabel_saldo AS ts"));
// SELECT tm.bank, tm.an_rekening, tm.no_rekening, ts.jumlah FROM tabel_member AS tm JOIN tabel_saldo AS ts ON ts.id_user = tm.id_user WHERE ts.id_user AND ts.id_user = 1;
?>
<div class="card mt-2">
                ...
                <div class="card-body d-flex justify-content-center align-items-center flex-column">
                  <div>
                    <h1 class="mb-0 text-center text-success border-bottom-primary border-2 round p-1 font-weight-bold">
                      <sup class="font-medium-2 text-dark">Rp.</sup><?= number_format($payment['jumlah'], 0, ",", "."); ?>
                    </h1>
                ...
                <form>
                  <div class="col-lg-12 col-12">
                    ...
                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                      <input type="text" class="form-control" value="<?= $payment["bank"] ?>">
                  ...
                  <div class="col-sm-6 col-12">
                    ...
                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                      <input type="text" class="form-control" value="<?= $payment["an_rekening"] ?>">
                  ...
                  <div class="col-sm-6 col-12">
                    ...
                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                      <input type="text" class="form-control" value="<?= $payment["no_rekening"] ?>">
...
<div class="modal fade text-left" id="deposit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content gradient-light-info">
      ...
      <form action="./aksi/aksi_saldo.php" method="POST">
        <div class="modal-body">
          <label>Nominal: </label>
          <div class="form-group">
            <input type="text" placeholder="tulis nominal deposit" class="form-control" name="jumlahDeposit">
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-dark" name="deposit">Deposit Saldo</button>
        </div>
      </form>
    </div>
  </div>
    ...
    <div class="modal-content gradient-light-danger">
      ...
      <form action="./aksi/aksi_saldo.php" method="POST">
        <div class="modal-body">
          <label>Nominal: </label>
          <div class="form-group">
            <input type="text" placeholder="tulis nominal penarikan" class="form-control" name="jumlahWithdraw">
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-dark" name="withdraw">Tarik Saldo</button>
        </div>
      </form>
    </div>
  </div>
