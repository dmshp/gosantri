...
<footer class="footer d-block d-sm-none d-md-block d-lg-none bg-white p-0 m-0" style="position: fixed">   
     <div class="btn-group">
		<a class="btn btn-icon font-small-2 mr-1" href="?menu=home">
			<img src="images/ico/home.png" width="30" class="pb-1"><br>Beranda</a> 
		<a class="btn btn-icon font-small-2 mr-1" href="?menu=profit">
			<img src="images/ico/ewallet.png" width="30" class="pb-1"><br>Pendapatan</a>
		 <a class="btn btn-icon font-small-2 mr-1" href="?menu=mchat">
			 <span class="badge badge-pill badge-primary badge-up badge-md mt-1 mr-1">5</span>
