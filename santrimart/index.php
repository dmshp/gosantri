...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="w/assets/css/swiper-bundle.min.css">-->
    <!-- BEGIN: Custom CSS-->
    <style>
    .swiper {
        width: 100%;
...
<body class="horizontal-layout horizontal-menu 2-columns navbar-floating footer-static ecommerce-application "
    ...
    <div class="app-content content pt-0">
                ...
                <div class="row pl-1 pr-1 pt-5 mt-3">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <div class="card pt-0 mt-2 shadow-none" style="background:none; height: 70%;">
                                <div id="carousel-contoh" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        ...
                                        <div class="carousel-item">
                                            <img class="img-fluid rounded" src="w/img/iklan/slide-4.jpg">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card pt-0 mt-2 shadow-none" style="background:none; height: 70%;">
                                <div>
                                    <img class="img-fluid rounded" src="w/img/iklan/promo-ovo.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="dasyat">
                    <div class="row justify-content-center2">
                        <div class="col-md-10 col-sm-10 col-xs-12">
                            <!-- <h5 style="text-align: left; padding: 10px; font-weight: 750; color: #ffae00;">PRODUK TERLARIS</h5> -->
                            <img style="height: 50px; margin-left: 20px; margin-top: 5px;" src="w/img/icon/flash-sale-.png">
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div style="text-align: end; padding: 10px; margin-top: 10px;">
                                <a href="./w/detail_flashsale.php">Lihat semua ></a>
                            </div>
                        </div>
                        <hr/>
                            ...
                            <div class="swiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide" style="width: 300 px !important;">
                                        <input type="hidden" name="id_user" id="id_user" readonly value="">
                                        <input type="hidden" name="kd_toko" id="kd_toko" readonly value="<?php echo $kdToko;?>">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="card-content slide-produk">
                                                        ...
                                                        <div class="float-right">
                                                            <div class="d-flex text-center">
                                                                <button
                                                                    ...
                                                                    onclick="add_keranjang(`<?php echo $stok ?>`,`<?php echo $kd_barang ?>`)">
                                                                    <i class="fas fa-shopping-cart"></i>
                                                                    BUY
                                                                </button>
                                                            </div>
                ...
                <section id="dasyat">
                    <div class="row justify-content-center2">
                        <div class="col-md-10 col-sm-10 col-xs-12" style="margin-top: 15px;">
                            <span class="text-header">PRODUK TERLARIS</span>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div style="text-align: end; padding: 10px; margin-top: 10px;">
        ...
        <div class="content-wrapper">
            <div class="card">
                <section id="dasyat">
                    <div class="row justify-content-center2">
                        <div class="col-md-10 col-sm-10 col-xs-12" style="margin-top: 15px;">
                            <span class="text-header">KOLEKSI TERBARU</span>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div style="text-align: end; padding: 10px; margin-top: 10px;">
                                <a href="./w/detail_produkbaru.php">Lihat semua ></a>
                            </div>
                        </div>
                        <hr/>
                        <div class="col-md-12 text-center">
        ...
        <!-- -------------------------------------- PRODUK KOMENTAR POSITIF TERBANYAK ------------------------------ -->
        <div class="content-wrapper" style="display: none;">
            <div class="card">
                <section id="dasyat">
                    <div class="row justify-content-center2">
                        <div class="col-md-10 col-sm-10 col-xs-12" style="margin-top: 15px;">
                            <span class="text-header">PRODUK REVIEW TERBANYAK</span>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                            <div style="text-align: end; padding: 10px; margin-top: 10px;">
                                <a href="">Lihat semua ></a>
        ...
        <!-- -------------------------------------- KONTAK DAN KONTRIBUTOR ------------------------------ -->
        <div class="content-wrapper">
            <div class="card">
                <section id="dasyat">
                    <div class="row justify-content-center2">
                        <div class="col-md-10 col-sm-10 col-xs-12" style="margin-top: 15px;">
                            <span class="text-header">KONTAK & KONTRIBUTOR</span>
                        </div>
                        <hr/>
                        ...
                        <div class="row pl-1 pr-1 mt-3">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="col-md-12 p-5 text-center card-kontak">
                                    <div class="col-md-12" style="margin-bottom: 20px">
                                        <center>
                                            <h3 style="font-weight: 550;">KONTAK</h3>
                                        </center>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="row card-kontak" style="padding-top: 35px; padding-bottom: 30px;">
                                    <div class="col-md-12">
                                        <center>
                                            <h3 style="font-weight: 550;">KONTRIBUTOR</h3>
                                        </center>
                                    </div>
                                    <div class="col-lg-4 col-md-12 col-sm-12">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="col-md-12 col-sm-12 ">
                                    <div class="card-kontak" style="height:100%">
        ...
        <div class="content-wrapper">
            <div class="card">
                <section id="hubungi">
                    <div class="row">
                        <div class="col-md-10 col-sm-10 col-xs-12" style="margin-top: 15px; margin-bottom: 15px;">
                            <span class="text-header">BAGIKAN PENGALAMANMU</span>
                        </div>
                        <div class="col-md-2 col-sm-2 col-xs-12">
                        </div>
                        <br/>
                    ...
                    <div class="row">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="w/aksi/add_comment.php" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" style="margin-bottom: 20px;" name="submit"
                                                class="btn btn-danger float-right btn-sm">Kirim</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-5 col-md-5 col-12">
                            <div class="card card-kontak" style="margin-right: 20px;">
    ...
    <!-- <script src="w/app-assets/js/scripts/extensions/fullcalendar.min.js"></script> -->
            ...
            if (stok <= 0) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location.href = "./w/page/index.php?menu=checkout";
