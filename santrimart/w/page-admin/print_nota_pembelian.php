...
<div style="width: 6cm; padding: 0 0.5cm; font-size: 14px;">
    ...
    <p style="text-align: center; margin: 0;">
        ...
        <?php
            ...
            echo strtoupper("Nota Pembelian");
    ...
    <?php
        $query = "SELECT * FROM `tabel_pembelian` INNER JOIN tabel_rinci_pembelian WHERE tabel_pembelian.no_faktur_pembelian = tabel_rinci_pembelian.no_faktur_pembelian AND tabel_pembelian.no_faktur_pembelian = '$no_faktur'";
        ...
        <?php
            ...
            if ($selectDataBarang) {
                ...
                while ($dataBarang = mysqli_fetch_array($selectDataBarang)) {
                    ...
                    $total = $dataBarang['total_pembelian'];
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-size: 12px;"><?php echo $dataBarang['sub_total_beli']?></td>
    ...
    <P style="margin: 0; text-align: center; font-size: 12px;">
        ...
        <a href="index.php?menu=wholesale" style="text-decoration: none; color: black; font-size: 14px;">Kembali</a>
    </P>
