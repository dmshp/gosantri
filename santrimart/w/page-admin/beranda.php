            ...
            <div id="user-profile">
                            ...
                            <div class="col-lg-5 col-md-12 col-sm-12">
                                <div class="card mb-1">
                                    <div class="card-body text-center">
                                        <h2 class="text-bold-700 text-uppercase mt-2"><i class="fas fa-user"></i> &nbsp;
                                            <i><?php echo $_SESSION['nm_user'];?></i>
                                        </h2>
                                        <span>
                ...
                <div class="row mt-1 mb-5">
                   <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                    ...
                    <!-- ----------- DAFTAR PRODUK FLASHSALE  --------------- -->
                    <section id="component-swiper-multiple">
                        <div class="card">
                            <div class="card-header">
                                <!-- <h6 class="text-bold-700 text-uppercase"> Produk Terbaru</h6> -->
                                <img class="text-title" style="height: 33px;" src="../img/icon/flash-sale-.png">
                            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="swiper-multiple swiper-container">
                                        <div class="swiper-wrapper">
                                            <?php 
                                                $query = "SELECT * FROM `tabel_barang` INNER JOIN tabel_barang_gambar INNER JOIN tabel_stok_toko WHERE tabel_barang.kd_barang = tabel_barang_gambar.id_brg AND tabel_barang.kd_barang = tabel_stok_toko.kd_barang ORDER BY tabel_barang.kd_barang DESC limit 6";
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <!-- <p class="text-right badge badge-success">                                    
                                    <a href="" style="text-decoration:none">Check All</a> 
                    ...
                    <section id="component-swiper-multiple">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-bold-700 text-uppercase"> Produk Terlaris</h6>
                                <!-- <p class="text-right badge badge-success">                                    
                                    <a href="" style="text-decoration:none">Check All</a> 
                                    <i class="fa-solid fa-angle-right"></i>
                                </p> -->
                    ...
                    <!-- ----------- DAFTAR PRODUK KOMENTAR TERBANYAK  --------------- -->
                    <section id="component-swiper-multiple">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="text-bold-700 text-uppercase"> Produk Komentar Terbanyak</h6>
                                <!-- <p class="text-right badge badge-success">                                    
                                    <a href="" style="text-decoration:none">Check All</a> 
                                    <i class="fa-solid fa-angle-right"></i>
                                </p> -->
