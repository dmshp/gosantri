            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?menu=home" class="text-dark">Laporan</a>
                            </li>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="divider">
                  <div class="divider-text"><h3 class="mb-3 display-4 text-uppercase">Master Laporan</h3></div>
                </div>

                <ul class="nav nav-tabs justify-content-center" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" href="#sales" role="tab" data-toggle="tab">
                      <i class="fa-solid fas fa-paste"></i> Laporan Penjualan
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#balance" role="tab" data-toggle="tab">
                      <i class="fa-solid fas fa-balance-scale"></i> Laporan Laba
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#stock" role="tab" data-toggle="tab">
                      <i class="fa-solid fa-clipboard-list"></i> Laporan Stock
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#bonus" role="tab" data-toggle="tab">
                      <i class="fa-solid fa-mail-bulk"></i> Laporan Bonus Penjualan
                    </a>
                  </li>
                </ul>
                <br><br>
                ...
                <div class="card-content">
                  <div class="card-body card-dashboard">
                    <div class="tab-content">
                      <div role="tabpanel" class="tab-pane fade show in active" id="sales">
                        <div class="divider-text">
                          <center>
                            <h4 class="mb-3 text-uppercase">-- Laporan Pejualan --</h4>
                          </center>
                        </div>

                        <div class="row">
                          <div class="col-lg-3 col-12 mb-3">
                            <form action="index.php?menu=laporan_merchant" method="post" name="postform">
                              <div class="divider">
                                  <div class="divider-text">
                              ...
                              <div class="input-group">
                                  <input type='text' name="tgl_awal_sales" id="tgl_awal_sales" class="form-control pickadate" value="<?php echo date('Y-m-d'); ?>" />
                              ...
                              <div class="input-group">
                                  <input type='text' name="tgl_akhir_sales" id="tgl_akhir_sales" class="form-control pickadate" value="<?php echo date('Y-m-d'); ?>" />
                                  <div class="input-group-append" id="button-addon2">
                          ...
                          <div class="col-lg-9 col-12 mb-1">
                            <?php
                              if (isset($_POST['cari'])) {
                              $tanggal_awal  = $_POST['tgl_awal_sales'];
                              $tanggal_akhir = $_POST['tgl_akhir_sales'];
                              ...
                              $jumlah = mysqli_fetch_array(mysqli_query($koneksi, "SELECT SUM(total_penjualan) AS total FROM tabel_penjualan ORDER BY tgl_penjualan DESC"));
                                ...
                                ?>
                              <span class="nama-user" style="color: #e50a32;">
                                  <i><b>Data Penjualan : </b> Pencarian dari tanggal <b><?php echo date("d-m-Y", strtotime($_POST['tgl_awal_sales'])) ?></b> sampai dengan tanggal <b><?php echo date("d-m-Y", strtotime($_POST['tgl_akhir_sales'])) ?></b>
                                  </i>
                              </span>
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="bonus">
                        <div class="divider-text">
                          <center>
