    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="text-dark">Delivery</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <input type="hidden" name="tarif_motor" id="tarif_motor" value="<?php echo $rupiah_motor;?>" readonly>
                        	<form action="../aksi/add_delivery_member.php" method="POST" enctype="multipart/form-data" id="distance_form">
		                        ...
		                        <input type="hidden" name="tot_rupiah" id="tot_rupiah" readonly>
		                     	...
		                     	<button type="button" class="btn btn-secondary btn-xs" id="btn_cari" name="btn_cari" title="Cari">
		                     		<i class="fas fa-search"></i>
		                     	</button> &nbsp;
		                     	<button type="button" class="btn btn-warning btn-xs" id="btn_cari" name="btn_cari" title="Refresh" onclick="window.location.reload()">
		                     		<i class="fas fa-refresh"></i>
		                     	</button> &nbsp;
		                     	<?php if($hasil == '0' ){ ?>
		                     	<button type="submit" class="btn btn-primary btn-xs" id="btn_cari" name="btn_cari" title="Proses Simpan Data">
		                     		SIMPAN
		                     	</button>
		                     	<?php } ?>
		                  	</form>
        ...
        <div class="card">
            <div class="card-body">
                <div class="divider">
                    <div class="divider-text">
                        <h3 class="mb-3 display-4 text-uppercase">Riwayat Delivery Order</h3>
                    </div>
                </div>
                        ...
                        ?>                                  
                          <tr>
                            ...
                            <td class="text-center">
                                <div class="badge badge-warning text-white"><?php echo strtoupper($m['user_batal']) ?></div>
                                <div class="badge badge-warning text-white"><?php echo date('d-m-Y H:i:s', strtotime($m['tgl_batal'])) ?></div>
                                <div class="badge badge-warning text-white"><?php echo $m['ket_batal'] ?></div>
                            </td>
                            <?php } else { ?>
                              <td class="text-center">-</td>
                            <?php } ?>
                            <td class="text-center">
                            	<a type="button" class="badge2 badge-warning text-white" readonly title="Info Detail" href="index.php?menu=delivery_member_detail&id_order=<?php echo $m['id']; ?>">
	                                <i class="fas fa-search"></i>
	                            </a>
                              	<?php if($m['sts_batal'] != '1'){ ?>
	                        	...
	                        	<?php } else if($m['sts_batal'] != '1' && $m['selesai'] != 'Y'){ ?>
                              	<a type="button" class="badge2 badge2-success text-white" title="Selesai Perjalanan" href="../aksi/proses_selesai_order_member.php?id_order=<?php echo $m['id']; ?>">
	                                <i class="fas fa-save"></i>
	                            </a>
                              	<?php } ?>
      ...
      <div class="modal-header">
        ...
        <form action="../aksi/batal_delivery_order.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-body">
	        	<input type="hidden" name="id_batal_order" id="id_batal_order" readonly>
	        	<div class="row">
	        		<div class="col-12">
