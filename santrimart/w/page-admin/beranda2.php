        ...
        <div class="row p-1">   
			...
			<center>
				...
				<div class="btn  gradient-light-primary btn-icon text-center btn-kecil" onclick="location.href = 'index.php?menu=home';">	
				 ...
				 <div class="btn  gradient-light-primary btn-icon text-center btn-kecil" onclick="location.href = 'index.php?menu=produk';">	
					<button type="button" class="btn btn-icon btn-white">
				 ...
				 <div class="btn  gradient-light-primary btn-icon text-center btn-kecil" onclick="location.href = 'index.php?menu=history';">
					<button type="button" class="btn btn-icon btn-white">
						<i class="fa-solid fa-receipt"></i>
					</button>
					<h5 class="font-small-1 pt-1">ORDER</h5>
				  </div> 	

				  <div class="btn  gradient-light-primary btn-icon text-center btn-kecil" onclick="location.href = 'index.php?menu=delivery_member';">		
					<button type="button" class="btn btn-icon btn-white">
						<i class="fa-solid fa-map-marker"></i>
					</button>
					<h5 class="font-small-1 pt-1">DELIVERY</h5>
				  </div> 
