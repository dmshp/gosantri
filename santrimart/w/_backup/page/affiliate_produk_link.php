              ...
              <div class="card-body pt-0">
                ...
                <div class="btn box-affiliate-member" href="">
                  <div class="col-12" style="">
                    <div class="controls">
                      <h5  style="color: black; font-weight:600;"><?php echo strtoupper($m['nm_barang']) ?> (<?php echo $m['kd_barang'] ?>)</h5>
                    </div>
                  </div>
                  <div class="col-12">
                    <h6 class="font-small-1" style="color: gray; margin-bottom: 15px;"><i><?php echo $m['link'] ?></i></h6>
                  </div>
                  <div class="col-12">
                  ...
                  <div class="swiper-wrapper">
                    <div class="col-3" style="align-self: center;">
                      <div class="controls">
                        <button type="button" class="btn2 btn-inline-info btn-sm" onclick="editLinkProduk(`<?php echo $m['id_link'] ?>`)">Edit</button>
                      </div>
                    </div>
                    <div class="col-9" style="">
                      <div class="controls">
                        <button type="button" class="btn2 btn-inline-danger btn-sm" onclick="hapusLinkProduk(`<?php echo $m['id_link'] ?>`)">Delete</button>
                      </div>
                    </div>
                  </div>
                </div>
