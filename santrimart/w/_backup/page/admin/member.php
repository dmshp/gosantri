          ...
          <div class="col-12">
            ...
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" class="text-dark">Member</a>
                </li>
              </ol>
            </div>
          </div>
      ...
      <div class="card-body">
        <div class="divider">
          <div class="divider-text">
            <h3 class="mb-3 display-4 text-uppercase">Data Member</h3>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-12">
            <div class="badge badge-primary float-right">
              <?php $sql_user = mysqli_query($koneksi, "SELECT * FROM tabel_member WHERE akses='member' AND stt_user='AKTIF'");
              $jumlah_user = mysqli_num_rows($sql_user); ?>
              <span class="badge badge-pill badge-up badge-danger font-small-2 mr-2">
                <?php echo $jumlah_user ?></span>Total member
            </div>
            <div class="table-responsive">
              <table class="table table-striped dataex-html5-selectors">
                ...
                <tbody>
                  <?php
                  $n=1;
                  $ketQuery = "SELECT * FROM tabel_member WHERE akses='member' AND stt_user='AKTIF' " ;
