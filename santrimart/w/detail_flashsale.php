                ...
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top pt-2">
                        <div class="col-12">
                            ...
                            <img class="content-header-title float-left mb-0 text-dark text-capitalize" style="height: 35px; margin-left: 20px; margin-top: 0px;" src="img/icon/flash-sale-.png">
