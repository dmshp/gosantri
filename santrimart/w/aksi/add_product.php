...
$nm_watermark = mysqli_fetch_array(mysqli_query($koneksi, "SELECT foto FROM tabel_member where kode_user = '$kode_user'"));
...
if(isset($_POST['upload_product'])){
 ...
 // die;
	...
	// 	return false;
	$query_tabel_barang = "INSERT INTO tabel_barang values('$kode', '$nama', '$satuan', '$kategori', '$kd_merchant', '$kd_toko' , '$deskripsi', '$berat', '$panjang', '$lebar', '$tinggi', '$warna', '$type', '$merk',  '$harga_beli', '$hrg_grosir',  '$hrg_jual', '$diskon', '$hrg_jual_disk')";
