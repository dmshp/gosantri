                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="text-dark">Retur Nota Penjualan</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="row mt-2 p-1">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                 <label for="basicInput">Cari Nota Jual</label>
                                 <input type="text" class="form-control" name="barang" id="barang" autofocus="autofocus" placeholder="Masukan Nota Penjualan" onkeyup="pilihProduk()">
                               </div>
                            </div>        
                        </div>
                                ...
                                <form class="form form-horizontal" method="post" action="../aksi/add_retur_new.php">
                                  <div class="form-body">
                                    <div class="row">
                                      ...
                                      <input type="hidden" name="retur_status" id="retur_status" class="form-control" readonly value="Nota Penjualan">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="badge badge-primary float-right">
                            <?php $sql_jml = mysqli_query($koneksi, "SELECT * FROM tabel_retur WHERE status = 'Nota Penjualan'");
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped dataex-html5-selectors">
                                ...
                                <tbody>
                                    <?php
                                      $ketQuery = "SELECT a.id, a.no_faktur_retur, a.kd_barang, case when b.nm_barang is null then '-' else b.nm_barang end as nm_barang, a.tgl_retur, a.total_retur, a.ket, a.status FROM tabel_retur a LEFT JOIN tabel_barang b ON a.kd_barang = b.kd_barang WHERE a.status = 'Nota Penjualan' order by a.no_faktur_retur DESC";
...
function pilihProduk(){
    ...
    if(nama == ""){
      ...
      $.ajax({
          type: "GET",
          url: '../aksi/tabel_pilih_nota_jual.php?key='+nama,
          dataType: "html",
          async: false,
          success: function(text) {
...
$.ajax({
    ...
    url: "../aksi/kasir_add_retur_to_table.php",
    ...
    success: function(data) {
        ...
        var text =`<tr id="kode${response.no_faktur_penjualan}">                                    
                        ...
                        <td>
                          <div class="d-inline-block mb-1">
                            <div class="input-group">
                              <input type="number" class="touchspin rounded-0" value="${response.jumlah}" onchange="cek_jumlah()">
                            </div>
                          </div>
                        </td>
                        <td id="sum_harga">${response.sub_total_jual}</td>
