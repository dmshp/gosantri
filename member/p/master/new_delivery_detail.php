    ...
    <div class="content-detached content-right">
      <div class="content-body">
        ...
        <section id="ecommerce-products" class="grid-view">
          ...
          a.rupiah,
          a.jenis_pembayaran, 
          a.kendaraan AS kendaraan_order,
          a.keterangan, 
          a.tgl_order, 
          COALESCE(a.pickup_id_kurir,'-') AS pickup_id_kurir, 
          COALESCE(a.tgl_pickup,'-') AS tgl_pickup, 
          COALESCE(a.pickup_nm_kurir,'-') AS pickup_nm_kurir, 
          COALESCE(b.hp ,'-') AS nomor_hp_kurir,
          COALESCE(a.selesai,'-') AS selesai, 
          COALESCE(a.konfirm_selesai,'-') AS konfirm_selesai, 
          COALESCE(a.sts_batal,'-') AS sts_batal, 
          COALESCE(a.tgl_batal,'-') AS tgl_batal, 
          COALESCE(a.ket_batal,'-') AS ket_batal, 
          COALESCE(a.user_batal,'-') AS user_batal, 
          COALESCE(c.kendaraan,'-') AS kendaraan_kurir,
          COALESCE(c.nomor_polisi,'-') AS nomor_polisi
      FROM 
          tabel_delivery_order a 
      LEFT JOIN 
          tabel_member b ON a.pickup_id_kurir = b.kode_user
      LEFT JOIN 
          tabel_kurir c ON b.kode_user = c.id_user
      WHERE 
          a.id = '$id_order' 
      ORDER BY 
          a.tgl_order DESC
          ...
          while ($m = mysqli_fetch_array($executeSat)) {
            ...
            <div class="row">
              <div class="col-12" style="margin-top: 10px; margin-bottom: 50px;">
                ...
                <input type="hidden" name="travel_mode" id="travel_mode" value="<?php echo $m['kendaraan_order'] ?>"
                  readonly />
                <input type="hidden" class="form-control" id="from_places" readonly
                  value="<?php echo $m['det_lokasi_awal'] ?>" />
                <input type="hidden" class="form-control" id="to_places" readonly
                  value="<?php echo $m['det_lokasi_akhir'] ?>" />
                <div id="map" style="height: 600px; width: 100%; margin-bottom: 30px;"></div>
                <button type="button" class="btn btn-success btn-sm float-right" id="btn_cari" name="btn_cari"
                  title="Cari">
            ...
            <div class="divider nama-user">
              <div class="divider-text">
                <h5 class="mb-3 display-7">Detail Delivery Order</h5>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly
                    value="<?php echo date('d-m-Y H:i:s', strtotime($m['tgl_order'])) ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly
                    value="<?php echo $m['jarak_lokasi'] ?> KM., (Rp. <?php echo number_format($m['rupiah']) ?>)">
                </div>
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly
                    value="<?php echo strtoupper($m['pickup_nm_kurir']) ?>">
                </div>
                <div class="form-group">
                  <label for="email">Kendaraan</label>
                  <?php if ($m['sts_batal'] != '1') { ?>
                    <input type="text" class="form-control" readonly
                      value="<?php echo strtoupper($m['kendaraan_kurir']) ?>, [ <?php echo strtoupper($m['nomor_polisi']) ?> ]">
                  <?php } else { ?>
                ...
                <div class="form-group">
                  ...
                  <?php if ($m['sts_batal'] == '1') { ?>
                    <input type="text" class="form-control" readonly
                      value="<?php echo date('d-m-Y H:i:s', strtotime($m['tgl_order'])) ?>, [ <?php echo strtoupper($m['user_batal']) ?> ]">
                  <?php } else { ?>
                    <input type="text" class="form-control" readonly value="-">
                  <?php } ?>
                </div>
