          ...
          <div class='row'>
            <div class='col-md-4 col-12'>
              <div class="text-title nama-user">
                <center>
                  <span>
                    <strong>AYO TENTUKAN DESTINASIMU SEKARANG</strong>, Cukup masukkan <i><u>lokasi awal dan lokasi
                        tujuan</u></i> kemana Kamu ingin pergi.
                  </span>
                </center>
              </div>
              ...
              SELECT distinct id_user, tanggal, jumlah, pengeluaran, ket_saldo, '0' AS jml FROM tabel_saldo WHERE id_user = '$id_user' ORDER BY tanggal DESC) x LIMIT 1)y)z"));
                ...
                <form action="../aksi/add_delivery_member.php" method="POST" enctype="multipart/form-data"
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="keterangan" cols="30" rows="4"
                  ...
                  <button type="button" class="btn btn-warning btn-sm" id="btn_cari" name="btn_cari" title="Refresh"
                    onclick="window.location.reload()">
                    <i class="fas fa-refresh"></i>
                  </button> &nbsp;
                  <?php if ($hasil == '0') { ?>
                    <button type="submit" class="btn btn-primary btn-sm" id="btn_cari" name="btn_cari"
                  ...
                  <div class="btn box-affiliate-member" href="">
                    ...
                    <div class="col-12">
                      <h6 class="font-small-1" style="color: gray; margin-bottom: 15px;">
                        <i>
                          <?php echo date('d-m-Y H:i:s', strtotime($m['tgl_order'])) ?>
                        </i>
                      </h6>
                    </div>
                    <?php if ($m['sts_batal'] == '1') { ?>
                      <div class="col-12">
                        <h5 class="font-small-1 nama-user" style="color: green;">
                          <?php echo strtoupper($m['user_batal']) ?> <i> [
                            <?php echo date('d-m-Y H:i:s', strtotime($m['tgl_batal'])) ?>]
                          </i>
                        </h5>
                        <h6 class="font-small-1 nama-user" style="color: red;">
                          <?php echo $m['ket_batal'] ?>
                        </h6>
                      </div>
                    <?php } else { ?>
                    ...
                    <div class="swiper-wrapper">
                      <div class="col-12">
                        <a type="button" class="badge2 badge-warning text-white" readonly title="Info Detail"
                          href="index.php?menu=delivery_detail&id_order=<?php echo $m['id']; ?>">
                          <i class="fas fa-search"></i>
                        </a>
                        ...
                        <?php if ($m['sts_batal'] != '1' && $m['selesai'] != 'Y') { ?>
                          <a type="button" class="badge2 badge-danger text-white" id="btn_batal_order"
                            name="btn_batal_order" title="Batal Order">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <textarea class="form-control" name="keterangan_batal" cols="30" rows="5"
                placeholder="Tambahkan Alasan dibatalkan" required></textarea>
            </div>
          </div>
        </div>
