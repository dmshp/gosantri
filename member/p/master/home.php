...
<!--======================= OVERLAY =========================-->
		<div id="myNav1" class="overlay">
		  <a href="javascript:void(0)" class="closebtn" onclick="closeNav1()"><i class="fa-solid fa-circle-xmark"></i></a>
...
<!--======================= OVERLAY =========================-->
		<div id="myNav2" class="overlay">
		  <a href="javascript:void(0)" class="closebtn" onclick="closeNav2()"><i class="fa-solid fa-circle-xmark"></i></a>
		  <div class="overlay-content">
			<?php include 'master/delivery.php'?>
		  </div>
		</div>
...
<!--======================= OVERLAY =========================-->
		<div id="myNav3" class="overlay">
		  <a href="javascript:void(0)" class="closebtn" onclick="closeNav3()"><i class="fa-solid fa-circle-xmark"></i></a>
		  <div class="overlay-content">
			<?php include 'master/delivery.php'?>
		  </div>
		</div>
...
<!--======================= OVERLAY =========================-->
		<div id="myNav5" class="overlay">
		  <a href="javascript:void(0)" class="closebtn" onclick="closeNav5()"><i class="fa-solid fa-circle-xmark"></i></a>
		  <div class="overlay-content">
			<?php include 'master/delivery.php'?>
		  </div>
		</div>
<!--======================= OVERLAY =========================-->
	   ...
	   <a class="btn btn-icon text-center btn-kecil" href="?menu=pay">		
	      <img src="images/ico/pay.png" width="60px">
			<h6 class="font-small-1 pt-1 text-Capitalize">SantriPay</h6>
	   </a>
 
	  <a class="btn btn-icon text-center btn-kecil" href="?menu=shop">	
	  <img src="images/ico/mart.png" width="60px">
