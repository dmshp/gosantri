        ...
        <section id="ecommerce-products" class="grid-view">
          <div class="row">
            <div class="col-6">
              <div class="btn-group">
                <div class="dropdown">
                  <button class="btn dropdown-toggle dropdown-toggle-split mr-1 mb-1" type="button"
                    id="dropdownMenuButton700" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-6">
              <div class="btn-group">
                <div class="dropdown">
                  <button class="btn dropdown-toggle mr-1 mb-1" type="button" id="dropdownMenuButton700"
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between">
                        ...
                        <small class="float-right  mb-25"
                          id="example-caption-2"><sup>Rp.</sup><?php echo number_format($harga, 0, ",", "."); ?></small>
                      </div>

                      <div class="progress progress-bar-success mb-1">
                        <div class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="95"
                          aria-valuemax="100" style="width:95%" aria-describedby="example-caption-2"></div>
                      </div>

                      <div class="btn-group" style="width:100%;">

                        <a href="?menu=product&kd_barang=<?php echo $d['kd_barang']; ?>"
                          class="btn btn-sm btn-icon gradient-light-success white"><i
                            class="fa-solid fa-book-open-reader"></i></a>
                        <a href="?menu=cart&kd_barang=<?php echo $d['kd_barang']; ?>"
                          class="btn btn-sm btn-icon gradient-light-danger white"><i
