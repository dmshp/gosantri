          ...
          <div class="row">
            <div class="col-lg-3 col-md-4 col-12">
              <div class="card">
                ...
                <div class="btn-group">
                  <button class="btn gradient-light-info white round box-shadow-1" data-toggle="modal"
                    data-target="#deposit">
                    Tambah <i class="feather icon-chevrons-right"></i></button>
                  <button class="btn gradient-light-danger white round box-shadow-1" data-toggle="modal"
                    data-target="#tarik">
...
<!---------=================MODAL DEPOSIT==========--------->
<div class="modal fade text-left" id="deposit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
  aria-hidden="true">
...
<!---------=================MODAL TARIK==========--------->
<div class="modal fade text-left" id="tarik" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
