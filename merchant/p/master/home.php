    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="justify-content-end align-items-center profile-header-nav">
          <a href="#" class="text-capitalize text-left font-small-1 badge badge-pill block bg-transparent text-dark p-1"
      ...
      <div class="col-6">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <span
                class="badge badge-pill gradient-light-warning badge-up badge-sm mt-2 mr-2 font-small-1 text-dark">NEW</span>
              ...
              <div class="progress progress-bar-success mb-1">
                <div class="progress-bar" role="progressbar" aria-valuenow="95" aria-valuemin="95" aria-valuemax="100"
                  style="width:95%" aria-describedby="example-caption-2"></div>
              </div>
              <!--------STATUS STOK---------------------------->
              <div class="btn-group">
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="progress progress-bar-danger mb-1">
                <div class="progress-bar" role="progressbar" aria-valuenow="15" aria-valuemin="15" aria-valuemax="100"
                  style="width:15%" aria-describedby="example-caption-2"></div>
              </div>
              <!--------STATUS STOK---------------------------->
              <div class="btn-group">
                <a href="?menu=product&kd_barang=P-0001"
