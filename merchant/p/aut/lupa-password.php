...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="shortcut icon" type="image/x-icon" href="../images/<?php echo $logo; ?>">
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    ...
                                                    <div class="carousel-item active">
                                                        ...
                                                        <?php $kode = $d['kd_barang'];
                                                            ...
                                                            // print_r($a)
                                                            ?>
                                                        <img class="card-img mb-0 pb-0" src="../images/produk/<?php echo $e[0]; ?>">
                                                    ...
                                                    <div class="carousel-item">
                                                        ...
                                                        <img class="card-img mb-0 pb-0"
                                                            src="../images/produk/<?php echo $c[0]; ?>">
                                                        <p class="card-text"><?php echo $toko; ?> </p>
                                                        <hr class="my-0">
                                                        <div class="justify-content-between mt-0">
                                                            <div class="float-left">
