                  ...
                  <div class="card rounded-0 mb-0 p-1">
                    <div class="divider mt-1">
                      <div class="divider-text mb-1">
                        <h3 class="text-uppercase text-info border-info p-1">Daftar MARKETING
                        </h3>
                      </div>
                    </div>
                    ...
                    <div class="card-body p-2">
                      ...
                      <br>
                      <form action="./aut/google-login/add_marketing_baru.php" method="POST"
                        ...
                        <fieldset class="form-label-group position-relative has-icon-left">
                          <input type="password" class="form-control" name="pass1" placeholder="Ketik Ulang Password"
                            required>
                          <div class="form-control-position">
                            <i class="feather icon-lock"></i>
                          </div>
                        ...
                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                          <input type="text" class="form-control" name="type_kendaraan"
                            placeholder="Merk / Type Kendaraan (Mobil / Motor)" required>
                          <div class="form-control-position">
                        ...
                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                          <input type="text" class="form-control" name="nomor_polisi" placeholder="Nomor Polisi"
                            required>
                          <div class="form-control-position">
                        ...
                        <button type="submit" name="daftar-merchant" class="btn btn-primary btn-inline mb-50"
                          name="submit_marketing" id="submit_marketing">
                          Daftar
                        </button>
                      </form>
                    </div>
