...
<footer class="footer d-block d-sm-none d-md-block d-lg-none bg-white p-0 m-0" style="position: fixed">   
     <div class="btn-group">
		<a class="btn btn-icon font-small-2 mr-1" href="?menu=mchat">
			...
			<img src="images/ico/chat.png" width="25" class="pb-1"><br>Chat</a>
		<a class="btn btn-icon font-small-2 mr-0" href="?menu=history">
			<img src="images/ico/history.png" width="25" class="pb-1"><br>Riwayat</a>
		<a class="btn btn-icon font-small-3 ml-0 mr-0" href="?menu=home">
			<img src="images/ico/home.png" width="30" class="pb-1"><br>Beranda</a> 
		<a class="btn btn-icon font-small-2 ml-0" href="?menu=pay">
			<img src="images/ico/dompetku.png" width="25" class="pb-1"><br>Dompetku</a>
		<a class="btn btn-icon font-small-2 ml-0" href="?menu=account">
			<img src="images/ico/akun.png" width="25" class="pb-1"><br>Akun</a> 
	 </div> 	
</footer>
 <!-- BEGIN: Footer-->
